...
class TypeScriptPlugin {
    ...
    async getDefinitions(document, position) {
        ...
        const result = await Promise.all(defs.definitions.map(async (def) => {
            ...
            return vscode_languageserver_1.LocationLink.create((0, utils_1.pathToUrl)(def.fileName), (0, utils_3.convertToLocationRange)(snapshot, def.textSpan), (0, utils_3.convertToLocationRange)(snapshot, def.textSpan), (0, utils_3.convertToLocationRange)(tsDoc, defs.textSpan));
        }));
